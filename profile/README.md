...
Se a HDEV te ajudar de alguma forma, deixe uma estrela ⭐ nos repositórios.  
Isso motiva a criação de mais conteúdos e ajuda a comunidade a crescer.

[![Stars](https://img.shields.io/github/stars/robsonamendonca?style=for-the-badge)](https://github.com/robsonamendonca)

---

## 📜 Licença

A HDEV oferece conteúdos livres para estudos.  
Cada repositório possui sua própria licença — consulte antes de reutilizar.

---

**HDEV | Desenvolvimento de Casa**  
_Desenvolvendo não só código — desenvolvendo pessoas._
